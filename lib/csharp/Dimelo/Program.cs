...
namespace Dimelo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (sso.BuildUri().ToString() != "https://example.users.dimelo.com/cas/login?auth=sso&type=acceptor&expires=1277309412&firstname=Renaud&service=http://example.ideas.dimelo.com/&token=c34d2ee42be49635c027d1a7c39fd2f5d8411f39&uuid=42")
            {
                Console.Write("F");
            }
            else {
