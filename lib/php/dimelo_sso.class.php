...
class DimeloSSO {
    ...
    function __construct($server, $salt, $service=null) {
        ...
        $this->TOKENIZED_PARAMS = array('avatar_url', 'custom_field_1', 'custom_field_10', 'custom_field_2', 'custom_field_3', 'custom_field_4', 'custom_field_5', 'custom_field_6', 'custom_field_7', 'custom_field_8', 'custom_field_9', 'email', 'expires', 'firstname', 'lastname', 'role', 'uuid');
        $this->PARAMS = array('avatar_url', 'charset', 'custom_field_1', 'custom_field_10', 'custom_field_2', 'custom_field_3', 'custom_field_4', 'custom_field_5', 'custom_field_6', 'custom_field_7', 'custom_field_8', 'custom_field_9', 'email', 'expires', 'firstname', 'lastname', 'role', 'service', 'token', 'uuid');
