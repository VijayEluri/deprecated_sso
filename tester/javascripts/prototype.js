...
Element.Methods = {
  visible: function(element) {
    //brutal patch for accessibility
    var element = $(element);
    return element.style.display != 'none' && !element.hasClassName('hidden-if-js-enable');
  },
  ...
  hide: function(element) {
    ...
    element.fire('visibility:changed', { visible: element.visible() });
    return element;
  },
  ...
  show: function(element) {
    ...
    element.removeClassName('hidden-if-js-enable');
    element.fire('visibility:changed', { visible: element.visible() });
    return element;
  },
